    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section id="inicio" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: "url('https://placeholder-image-service.onrender.com/image/1920x1080?prompt=Serene%20therapy%20office%20with%20comfortable%20chair,%20plants,%20and%20soft%20lighting&id=hero-bg-001')"
          }}
        />
